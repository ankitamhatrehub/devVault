...
import { getProfileController, updateProfileController, changePasword, } from "./profile.controller.js";
...
router.post("/upload", authMiddleware, upload.single("file"), uploadProfileImageController);
