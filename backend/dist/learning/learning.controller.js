...
import { createLearningService, getAllLearningsService, getLearningByIdService, updateLearningService, deleteLearningService, } from "./learning.service.js";
export const createLearningController = async (req, res) => {
    try {
...
export const getAllLearningsController = async (req, res) => {
    try {
        const userId = req.user.userId;
...
export const getLearningByIdController = async (req, res) => {
    try {
        const userId = req.user.userId;
        const { id } = req.params;
        if (!id) {
...
export const updateLearningController = async (req, res) => {
    try {
        const userId = req.user.userId;
        const { id } = req.params;
        const { title, des, category, status, priority, startDate, targetDate, steps } = req.body;
...
export const deleteLearningController = async (req, res) => {
    try {
        const userId = req.user.userId;
        const { id } = req.params;
        if (!id) {
